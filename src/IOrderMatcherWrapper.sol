...
interface IOrderMatcherWrapper {
    ...
    // function placeLimitOrder(uint256 orderType, address token0, address token1, uint256 amount, uint256 price, uint256 eid) external 
